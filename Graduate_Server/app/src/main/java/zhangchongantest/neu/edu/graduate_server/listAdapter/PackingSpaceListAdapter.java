...
public class PackingSpaceListAdapter extends CursorAdapter{
    private final int mResourceId;
    public PackingSpaceListAdapter(Context context, int mResourceId,Cursor cursor) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        tv_item3.setText(cursor.getString(4));
    }
}
